" file from: https://github.com/tomlion/vim-solidity (MIT license)
...
setlocal indentexpr=GetInoxIdent()
setlocal indentkeys=0{,0},0),0],0\,,!^F,o,O,e

" Only define the function once.
if exists("*GetInoxIdent")
  finish
endif
...
" 3. GetInoxIdent Function {{{1
" =========================

function GetInoxIdent()
  " 3.1. Setup {{{2
  " ----------
